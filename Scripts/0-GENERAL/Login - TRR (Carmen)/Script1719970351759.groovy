...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - UsernameEmail Address'), 'carmen', 0)

Mobile.setEncryptedText(findTestObject('Object Repository/android.widget.EditText - Password'), '95lxcd4//rk=', 0)
