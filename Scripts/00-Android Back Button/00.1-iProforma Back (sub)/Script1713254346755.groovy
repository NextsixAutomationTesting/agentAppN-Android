...
Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Claims'), 0)

Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - ClaimsIN'), 0)

Mobile.delay(1)

Mobile.pressBack()

Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Receipt'), 0)

Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Request'), 0)
...
Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - History'), 0)
...
Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Receipt (1)'), 0)
...
Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Invoice'), 0)

Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Request (1)'), 0)
...
Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - History (1)'), 0)
...
Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Invoice (1)'), 0)

Mobile.delay(1)

Mobile.pressBack()

Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Settings'), 0)

Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Change Password'), 0)
...
Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - My Payment Voucher'), 0)
...
Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - My Profile'), 0)
...
Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Store'), 0)

Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Order'), 0)
...
Mobile.tap(findTestObject('00 Back Button/android.widget.TextView - Shop'), 0)

Mobile.delay(2)

Mobile.pressBack()

if(Mobile.verifyElementNotVisible(findTestObject('00 Back Button/android.widget.TextView - Settings'), 3, FailureHandling.OPTIONAL)) 
	{
		Mobile.pressBack()
	}
