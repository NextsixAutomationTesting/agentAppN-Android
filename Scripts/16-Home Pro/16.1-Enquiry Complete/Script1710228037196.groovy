...
String enquiryStat = Mobile.getText(findTestObject('16 HomePro/android.widget.TextView - status'), 0)
...
Mobile.tap(findTestObject('Object Repository/16 HomePro/android.widget.TextView - My Referral (1)'), 0)

Mobile.tap(findTestObject('16 HomePro/android.widget.TextView - Completed'), 0)

String enquiryStatCom = Mobile.getText(findTestObject('16 HomePro/android.widget.TextView - CompletedStatus'), 0)

enquiryAmoCom = Mobile.getText(findTestObject('16 HomePro/android.widget.TextView - RM 1234'), 0)

assert enquiryStatCom == 'Completed'

assert enquiryAmoCom == 'RM '+ referAmount

Mobile.callTestCase(findTestCase('16-Home Pro/16.2-Enquiry Attachments (sub)'), [:], FailureHandling.STOP_ON_FAILURE)
