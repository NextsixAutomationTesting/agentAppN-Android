...
Mobile.tap(findTestObject('12 Agent Profile/android.widget.TextView - level'), 0)
...
Mobile.verifyElementVisible(findTestObject('12 Agent Profile/android.widget.TextView - Submitted'), 20)
