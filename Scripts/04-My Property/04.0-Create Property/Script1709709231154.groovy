...
Mobile.waitForElementPresent(findTestObject('Object Repository/04 Property/android.view.View - ball-triangle-loading'), 0)

Mobile.tap(findTestObject('Object Repository/04 Property/android.view.View - ball-triangle-loading'), 1)
...
Mobile.waitForElementAttributeValue(findTestObject('Object Repository/04 Property/android.view.View - ball-triangle-loading'), 'text', 'Upload or drag Images', 300)
