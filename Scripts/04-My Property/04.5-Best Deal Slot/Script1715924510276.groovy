...
Mobile.callTestCase(findTestCase('0-GENERAL/Login - Best Deal (Mentos)'), [:])
...
Mobile.tap(findTestObject('Object Repository/04 Property/android.widget.TextView - Set As Best Deal'), 0)

Mobile.tap(findTestObject('Object Repository/04 Property/android.widget.TextView - Yes'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/04 Property/android.widget.TextView - Best Deal'), 0)
...
Mobile.tap(findTestObject('Object Repository/04 Property/android.widget.TextView - Duplicate Property (1)'), 0)

Mobile.callTestCase(findTestCase('0-GENERAL/PermissionPopup'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/04 Property/android.widget.TextView - back'), 0)

Mobile.tap(findTestObject('Object Repository/04 Property/android.widget.TextView - back'), 0)

Mobile.tap(findTestObject('04 Property/android.widget.TextView - Exit'), 1)

usedBDS = WS.sendRequest(findTestObject('04 Property/usedBestDeal'))
...
Mobile.tap(findTestObject('Object Repository/04 Property/android.widget.TextView - Remove From Best Deal'),0)
