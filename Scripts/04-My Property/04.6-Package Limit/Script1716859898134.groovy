...
WebUI.callTestCase(findTestCase('0-GENERAL/Login - TRR (Carmen)'), [:])
...
Mobile.verifyElementVisible(findTestObject('Object Repository/04 Property/android.widget.TextView - Youve reached your maximum active listing'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/04 Property/android.widget.TextView - Ok'), 0)

Mobile.scrollToText('Caramel')
