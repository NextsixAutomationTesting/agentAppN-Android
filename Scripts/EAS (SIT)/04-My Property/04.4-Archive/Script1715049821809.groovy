...
autoArchive = WS.sendRequest(findTestObject('EAS/04 Property/autoArchive'))
...
autoArchived = WS.sendRequest(findTestObject('EAS/04 Property/autoArchived'))
...
Mobile.tap(findTestObject('Object Repository/EAS/04 Property/android.widget.TextView - Archive'), 0)
...
Mobile.tap(findTestObject('Object Repository/EAS/04 Property/android.widget.TextView - FOR SALES'),0)
