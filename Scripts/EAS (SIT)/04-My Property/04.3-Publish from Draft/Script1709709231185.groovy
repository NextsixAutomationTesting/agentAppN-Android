...
Mobile.setText(findTestObject('EAS/04 Property/android.widget.EditText - selling price'), '222111', 0)

Mobile.hideKeyboard()

Mobile.setText(findTestObject('EAS/04 Property/android.widget.EditText - buildup size'), '678', 0)

Mobile.hideKeyboard()

Mobile.setText(findTestObject('EAS/04 Property/android.widget.EditText - highlight'), 'publish from draft', 0)
...
Mobile.setText(findTestObject('EAS/04 Property/android.widget.EditText - Bathrooms'), '2', 0)

Mobile.setText(findTestObject('EAS/04 Property/android.widget.EditText - Carparks'), '2', 0)
