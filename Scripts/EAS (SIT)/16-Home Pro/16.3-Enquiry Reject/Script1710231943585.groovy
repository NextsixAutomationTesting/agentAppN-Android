...
WS.sendRequest(findTestObject('EAS/16 HomePro/rejectEnquiry', [('enquiryId') : enquiryId, ('reasonReject') : reasonReject]))

Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - My Referral'), 0)

Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - Completed'), 0)

String enquiryStatRej = Mobile.getText(findTestObject('EAS/16 HomePro/android.widget.TextView - CompletedStatus'), 0)

reasonRej = Mobile.getText(findTestObject('EAS/16 HomePro/android.widget.TextView - Reason rejected'), 0)
...
String enqStatus = Mobile.getText(findTestObject('EAS/16 HomePro/android.widget.TextView - status'), 0)
...
def latestEnquiry2 = WS.sendRequest(findTestObject('EAS/16 HomePro/latestEnquiry'))
...
WS.sendRequest(findTestObject('EAS/16 HomePro/cancelMerchant', [('enqId') : enqId, ('role') : role, ('merchantCancel'):merchantCancel] ))

Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - My Referral'), 0)

Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - Completed'), 0)

String enqMercCancel = Mobile.getText(findTestObject('EAS/16 HomePro/android.widget.TextView - CompletedStatus'), 0)

reasonCan = Mobile.getText(findTestObject('EAS/16 HomePro/android.widget.TextView - Reason rejected'), 0)
...
String enqStatus1 = Mobile.getText(findTestObject('EAS/16 HomePro/android.widget.TextView - status'), 0)
...
def latestEnquiry3 = WS.sendRequest(findTestObject('EAS/16 HomePro/latestEnquiry'))
...
WS.sendRequest(findTestObject('EAS/16 HomePro/cancelClient', [('enqId') : enqId1, ('role') : role2, ('clientCancel'):clientCancel] ))

Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - My Referral'), 0)

Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - Completed'), 0)

String enqMercCancel1 = Mobile.getText(findTestObject('EAS/16 HomePro/android.widget.TextView - CompletedStatus'), 0)

reasonCan1 = Mobile.getText(findTestObject('EAS/16 HomePro/android.widget.TextView - Reason rejected'), 0)
