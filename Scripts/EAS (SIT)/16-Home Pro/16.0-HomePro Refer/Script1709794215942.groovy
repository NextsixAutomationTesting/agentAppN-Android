...
Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - search'), 0)

Mobile.setText(findTestObject('EAS/16 HomePro/android.widget.EditText - Search for banker'), 'james', 0)

Mobile.hideKeyboard()

Mobile.tapAtPosition(550, 830)

Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - James Broke'), 0)

Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - Refer This Merchant'), 0)
...
Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - back'), 0)

Mobile.tap(findTestObject('EAS/16 HomePro/android.widget.TextView - back homepro'), 0)
