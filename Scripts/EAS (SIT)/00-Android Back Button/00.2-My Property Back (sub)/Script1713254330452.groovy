...
Mobile.tap(findTestObject('EAS/00 Back Button/android.widget.TextView - My Property'), 0)
...
Mobile.tap(findTestObject('EAS/00 Back Button/android.widget.ImageView - memo'), 0)

Mobile.waitForElementPresent(findTestObject('EAS/00 Back Button/android.widget.EditText - Leave your memo here'), 0)
...
memoClose = Mobile.verifyElementExist(findTestObject('EAS/00 Back Button/android.widget.EditText - Leave your memo here'), 
    0, FailureHandling.OPTIONAL)

if (memoClose == true) {
    Mobile.tap(findTestObject('EAS/00 Back Button/android.widget.ImageView - close memo'), 0)
