...
Mobile.tap(findTestObject('EAS/13 Academy/android.widget.TextView - Agency Letter'), 0)

Mobile.tap(findTestObject('EAS/13 Academy/android.widget.TextView - Your GPS to success.pdf'), 0)

Mobile.verifyElementVisible(findTestObject('EAS/13 Academy/android.widget.TextView - Peview'), 10)

Mobile.pressBack()

Mobile.tap(findTestObject('EAS/13 Academy/android.widget.TextView - download'), 0)
...
if (Mobile.verifyElementVisible(findTestObject('Object Repository/EAS/13 Academy/android.widget.Button - Cancel'), 3, FailureHandling.OPTIONAL)) 
	{Mobile.tap(findTestObject('Object Repository/EAS/13 Academy/android.widget.Button - Cancel'), 0)}
...
Mobile.tap(findTestObject('EAS/13 Academy/android.widget.TextView - back (1)'), 0)
