...
packageName = Mobile.getText(findTestObject('15 Dashboard/android.widget.TextView - Pack'), 0)

expiryDate = Mobile.getText(findTestObject('15 Dashboard/android.widget.TextView - Expiring'), 0)

Mobile.tap(findTestObject('15 Dashboard/android.widget.TextView - Listing'), 0)

totalProp = Mobile.getText(findTestObject('15 Dashboard/android.widget.TextView - total prop'), 0)

saleProp = Mobile.getText(findTestObject('15 Dashboard/android.widget.TextView - For Sale'), 0)

rentProp = Mobile.getText(findTestObject('Object Repository/15 Dashboard/android.widget.TextView - For Rent (1)'), 0)

dashboardBDS = Mobile.getText(findTestObject('Object Repository/15 Dashboard/android.widget.TextView - Used'), 0)

Mobile.tap(findTestObject('15 Dashboard/android.widget.TextView - Plotting'), 0)

plotAddress = Mobile.getText(findTestObject('15 Dashboard/android.widget.TextView - address'), 0)
