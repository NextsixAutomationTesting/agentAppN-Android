...
Mobile.setText(findTestObject('Object Repository/EAS/android.widget.EditText - UsernameEmail Address'), 'cayden', 0)

Mobile.setEncryptedText(findTestObject('Object Repository/EAS/android.widget.EditText - Password'), 'H0pLMoc45+4=', 0)
